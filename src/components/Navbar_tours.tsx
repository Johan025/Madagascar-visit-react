        ...
        <div className="nav_secondary">
          ...
          <div className="nav_toggle">
            <ul className="d-flex m-4 justify-content-end">
              <li><Link to="/" className="a" ><FontAwesomeIcon icon={faHome} className="icon"/> HOME</Link></li>
              <li><Link to="/tours" className="a" id="active"><FontAwesomeIcon icon={faCar} className="icon"/> OUR TOURS</Link></li>
